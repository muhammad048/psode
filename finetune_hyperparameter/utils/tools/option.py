...
from utils.data.cifar_loader_1 import create_loader_cifar_10,create_loader_cifar_100
from utils.data.cifar_loader_2 import create_loader_cifar
...
parser.add_argument('--lr_min', type=float, default=1e-5, metavar='LR',
...
parser.add_argument('--loss_ratio', nargs='+', type=float, help='A list of loss ratio.')
parser.add_argument('--time_ratio', nargs='+', type=float, help='A list of loss ratio.')
parser.add_argument('--cal_ratio_loss',
                    default=False,
                    type=bool,
                    metavar='N',
                    help='if use Temporal Efficient Training (default: True)')
parser.add_argument('--save_model_interval', default=5, type=int, help='save_model_interval')
parser.add_argument('--No_dataset', type=int, default=0, metavar='N',
                    help='Which dataset will be used')
parser.add_argument('--split_num', default=5, type=int,
                    help='The number of split.')
parser.add_argument('--re_prob', default=None, type=float,
                    metavar='N', help='re_prob')
...
def obtain_loader(args):
    print("create dataset: ",args.dataset_name)
    if args.dataset_name == 'cifar100':
        loader_train,loader_eval = create_loader_cifar(args)
